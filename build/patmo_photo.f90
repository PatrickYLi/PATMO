...
contains
  ...
  subroutine loadAllPhotoXsecs()
    ...
    !SO -> S + O
    call loadPhotoXsec("xsecs/SO__S_O.dat",3)
    !O2 -> O + O
    call loadPhotoXsec("xsecs/O2__O_O.dat",4)
    !O3 -> O2 + O
    call loadPhotoXsec("xsecs/O3__O2_O.dat",5)
    !CS2 -> CS + S
    call loadPhotoXsec("xsecs/CS2__CS_S.dat",6)
    !CS2 -> CS2E
    call loadPhotoXsec("xsecs/CS2__CS2E.dat",7)
